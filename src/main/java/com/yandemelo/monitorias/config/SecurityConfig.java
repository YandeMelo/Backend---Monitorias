...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        .requestMatchers(HttpMethod.GET, "/monitorias/arquivo/{idAluno}/{idArquivo}").permitAll()
        ...
        .requestMatchers(HttpMethod.PUT, "/monitorias/suspender/{id}").hasRole("PROFESSOR")
        ...
        .requestMatchers(HttpMethod.PUT, "/professor/recusar/{idAluno}/{idMonitoria}").hasRole("PROFESSOR")
        .requestMatchers(HttpMethod.PUT, "/professor/aprovar/{idAluno}/{idMonitoria}").hasRole("PROFESSOR")
        ...
        .requestMatchers(HttpMethod.GET, "/professor/historico/{idArquivo}").hasAnyRole("PROFESSOR", "ALUNO")
